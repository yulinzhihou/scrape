...
class RoleDetailCreate extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('base_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'基本页信息'])
            ->addColumn('skill_info','text',['null'=>false,'comment'=>'技能页信息'])
            ->addColumn('book_info','text',['null'=>false,'comment'=>'秘籍页信息'])
            ->addColumn('pet_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'珍兽页信息'])
            ->addColumn('bag_item_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'仓库物品信息'])
            ->addColumn('bag_equip_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'仓库装备信息'])
            ->addColumn('bag_pet_equip_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'仓库珍兽装备信息'])
            ->addColumn('bag_infants_info','text',['null'=>false,'comment'=>'仓库子女时装信息'])
            ->addColumn('cloth_info','text',['limit'=>MysqlAdapter::TEXT_LONG,'null'=>false,'comment'=>'时装外观信息'])
