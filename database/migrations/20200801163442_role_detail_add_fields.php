...
class RoleDetailAddFields extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('gem_xiu_lian_score','integer',['signed'=>false,'after'=>'title','limit'=>MysqlAdapter::INT_TINY,'default'=>0,'null'=>false,'comment'=>'心法评分'])
            ->addColumn('gem_jin_jie_score','integer',['signed'=>false,'after'=>'gem_xiu_lian_score','limit'=>MysqlAdapter::INT_TINY,'default'=>0,'null'=>false,'comment'=>'心法评分'])
            ->update();
    }
}
