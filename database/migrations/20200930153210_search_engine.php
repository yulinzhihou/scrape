...
class SearchEngine extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('search_engine',['primary key'=>'id','auto_increment'=>true,'engine'=>'innodb','comment'=>'搜索引擎'])->addIndex('id');
        $table
            ->addColumn('name','string',['limit'=>32,'null'=>false,'default'=>'','comment'=>'搜索引擎名称'])
